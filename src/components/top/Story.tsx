...
const PARAGRAPHS = [
  '僕がものづくりを始めた原点は、小学生の頃のダンボール工作でした。代表作は「お金を入れないと動かない」ガチャガチャ。高校でプログラミングに出会い、同級生向けに作ったサービスは、気づけば学年の8割が使うものになっていました。「こうしてほしい」と言われるたびに直し、そのたびに喜ばれる——あの体験が、今も仕事の原点にあります。',
